...
public class SurveyController {
    ...
    @PostMapping("{userId}")
    @ResponseBody
    public SurveyCreateByUserResponseDto createSurvey(@PathVariable("userId") Long userId
    ...
    @ResponseBody
    public QuestionCreateResponseDto createQuestion(@PathVariable("userId") Long userId
